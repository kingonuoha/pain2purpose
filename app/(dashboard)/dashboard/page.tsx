                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                                    <div className="space-y-6 md:col-span-2">
                                                        <div className="flex items-center gap-6">
                                                            <div className="relative w-24 h-24 rounded-full bg-zinc-100 border border-zinc-200 flex-shrink-0 overflow-hidden group">
                                                            ...
                                                            <div>
                                                                <h4 className="text-sm font-bold text-p2p-charcoal">Profile Picture</h4>
                                                                <p className="text-xs text-zinc-500 mt-1">Upload a new avatar to appear in comments and community.</p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div className="space-y-3">
                                                        <label className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 ml-1">Full Name <span className="text-red-500">*</span></label>
                                                        <input
                                                            name="name"
                                                            required
