        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 transition-colors duration-500">
                <div className="relative">
                    <div className="w-16 h-16 rounded-2xl bg-[#7C9A7E]/10 flex items-center justify-center border border-[#7C9A7E]/20 shadow-2xl overflow-hidden">
                        <Activity className="text-[#7C9A7E] animate-pulse" size={32} />
                    </div>
                    <div className="absolute inset-x-0 -bottom-8 flex justify-center">
                        <div className="flex gap-1">
                            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 1 }} className="w-1.5 h-1.5 rounded-full bg-[#7C9A7E]" />
                            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 1, delay: 0.2 }} className="w-1.5 h-1.5 rounded-full bg-[#7C9A7E]/60" />
                            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 1, delay: 0.4 }} className="w-1.5 h-1.5 rounded-full bg-[#7C9A7E]/30" />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            <div className="w-1.5 h-8 bg-[#7C9A7E] rounded-full" />
                        ...
                        <p className="text-zinc-500 dark:text-zinc-400 font-sans max-w-lg text-sm leading-relaxed">
                            Command & Control center for <span className="text-zinc-900 dark:text-white font-bold underline decoration-[#7C9A7E]/30 underline-offset-4">Pain2Purpose</span>.
                            Greetings, <span className="text-[#7C9A7E] dark:text-[#7C9A7E] font-black tracking-tight">{session?.user?.name || 'Administrator'}</span>.
                        </p>
                    </div>
                                ...
                                <AreaChart data={chartData}>
                                    <defs>
                                        <linearGradient id="colorViews" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="5%" stopColor="#7C9A7E" stopOpacity={0.1} />
                                    ...
                                    <Tooltip
                                        ...
                                        cursor={{ stroke: '#7C9A7E', strokeWidth: 1, strokeDasharray: '4 4' }}
                                    />
                                    <Area
                                        type="monotone"
                                        dataKey="views"
...
function StatCard({
    ...
    trend?: string,
    trendUp?: boolean,
    color: 'sage' | 'purple' | 'sand',
    delay?: number
}) {
    const variants = {
        sage: "bg-[#7C9A7E]/10 text-[#7C9A7E] dark:text-[#7C9A7E] border-[#7C9A7E]/20 group-hover:bg-[#7C9A7E] group-hover:text-white transition-all duration-500",
        ...
        sand: "bg-[#C4A882]/10 text-[#C4A882] dark:text-[#C4A882] border-[#C4A882]/20 group-hover:bg-[#C4A882] group-hover:text-white transition-all duration-500"
    };
        ...
        >
            ...
            <div className="mt-auto relative z-10">
                ...
                <div className="flex items-center gap-3 pt-5 border-t border-zinc-100 dark:border-zinc-800/50">
                    <div className={cn("w-2 h-2 rounded-full", color === 'sage' ? 'bg-[#7C9A7E]' : color === 'purple' ? 'bg-purple-500' : 'bg-[#C4A882]')} />
